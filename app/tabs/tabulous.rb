...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :products_tab            ,    'Products'            ,    products_path            ,    true        ,    true        ],
      [    :invoices_tab            ,    'Invoices'            ,    invoices_path            ,    true        ,    true        ],
      [    :account_contacts_tab    ,    'Account Contacts'    ,    account_contacts_path    ,    true        ,    true        ],
      [    :accounts_tab            ,    'Accounts'            ,    accounts_path            ,    true        ,    true        ],
      [    :dashboard_tab           ,    'Dashboard'           ,    dashboard_index_path     ,    true        ,    true        ],
      [    :dashboard_tab           ,    'Dashboard'           ,    root_path                ,    true        ,    true        ],
      #------------------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                 |    DISPLAY TEXT          |    PATH                     |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      [    :products            ,    :all_actions    ,    :products_tab            ],
      [    :invoices            ,    :all_actions    ,    :invoices_tab            ],
      [    :account_contacts    ,    :all_actions    ,    :account_contacts_tab    ],
      [    :accounts            ,    :all_actions    ,    :accounts_tab            ],
